...
import Logo from "../../../assets/img/imagineDifferent.png";
...
class ListItem extends React.Component {
  ...
  renderPic = movie => {
    if (movie.backdrop_path !== null) {
      return <img className="tile-img" alt="img" src={movie.thumbnail} />;
    }
    if (movie.thumbnail !== null) {
      return <img className="tile-img " alt="img" src={Logo} />;
    }
    return (
      <img
        alt="img"
